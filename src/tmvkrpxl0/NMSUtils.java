...
public class NMSUtils {
	...
	public enum Biome {
		 ...
		 * blocks tall with 2횄��2 thick trunks. Oak trees are also common. The landscape is lush green and quite hilly,
		 * with many small lakes of water often nestled into deep valleys, sometimes above sea level. Leaves cover much
		 * of the forest floor창�궗�쓙hese "bush trees" have single-blocks of jungle wood for trunks, surrounded by oak
		 ...
		 * trees are 2횄��2 thick and very tall, not unlike large jungle trees. Moss stone boulders appear frequently,
		...
		SAVANNA_PLATEAU(36),
		/**
		 * A rare biome consisting of hardened clay, stained clay, and dead bushes 창�궗�� similar to a desert. Red sand
		...
		MESA_PLATEAU(39),
		/**
		 * A completely empty biome that generates only a single structure: a 33횄��33 stone platform with a single block
		...
		/**
		 * ~l횄짤 sigh~ A Collection consisting of every single biome type in the game.
		 */
